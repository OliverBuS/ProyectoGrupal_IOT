...
public class TISolicitudesAdapter extends RecyclerView.Adapter<TISolicitudesAdapter.TISolicitudViewHolder> {
    ...
    @NonNull
    @Override
    public TISolicitudViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycle_solicitud_lista_ti, parent, false);
        return new TISolicitudViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TISolicitudViewHolder holder, int position) {
    ...
    public TISolicitudesAdapter(List<Solicitud> itemList, Context context, RecycleviewerInterface recycleviewerInterface) {
    ...
    public class TISolicitudViewHolder extends RecyclerView.ViewHolder {
        Solicitud solicitud;

        public TISolicitudViewHolder(@NonNull View view) {
